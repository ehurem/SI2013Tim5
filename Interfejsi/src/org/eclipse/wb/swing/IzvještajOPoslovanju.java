...
public class IzvještajOPoslovanju {

	private JFrame frmIzvjetajOPoslovanju;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IzvještajOPoslovanju window = new IzvještajOPoslovanju();
					window.frmIzvjetajOPoslovanju.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		frmIzvjetajOPoslovanju = new JFrame();
		frmIzvjetajOPoslovanju.setTitle("Izvje\u0161taj o poslovanju");
		frmIzvjetajOPoslovanju.setBounds(100, 100, 452, 394);
		frmIzvjetajOPoslovanju.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		GroupLayout groupLayout = new GroupLayout(frmIzvjetajOPoslovanju.getContentPane());
		...
		frmIzvjetajOPoslovanju.getContentPane().setLayout(groupLayout);
	}
}
