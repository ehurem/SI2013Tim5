	...
	private void initialize() {
		...
		btnZatvoriZahtjev.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(frmZatvaranjeZahtjeva, "Zatvaranje zahtjeva nije implementirano!");
				frmZatvaranjeZahtjeva.dispose();
				//s.Show();
		...
		textField = new JTextField(Long.toString(id));
		textField.setEditable(false);
		textField.setColumns(10);
		
		textField_1 = new JTextField(imeiprezime);
		textField_1.setEditable(false);
		textField_1.setColumns(10);
		
		textField_2 = new JTextField(uredaj);
